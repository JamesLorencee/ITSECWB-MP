...
--
-- Dumping events for database 'itsecwb-mp'
--
/*!50106 SET @save_time_zone= @@TIME_ZONE */ ;
/*!50106 DROP EVENT IF EXISTS `delete_expired_jwt` */;
DELIMITER ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `delete_expired_jwt` ON SCHEDULE EVERY 15 MINUTE STARTS '2024-06-12 17:06:46' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    DELETE FROM jwt_blacklist WHERE expiration_time <= NOW();
END */ ;;
...
--
-- Dumping routines for database 'itsecwb-mp'
--
...
-- Dump completed on 2024-06-14 23:24:42
